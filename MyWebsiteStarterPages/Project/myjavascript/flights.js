//var myflightsapp = angular.module("flights", []);
myindexpageapp.controller("flightscontroller", function ($scope, $http) {
...
,
    ...
    $scope.getcomments = function (a) {
        console.log("from comments " + a.name);
        $scope.comments = ['We then boarded the airplane and had to wait because they wanted to send mechanic parts to San Diego so we sat on the plane another hour.',
