var myapp = angular.module("app_p1_p6", []);

myapp.controller("controller_p1_p6", function ($scope, $http) {
    ...
    $scope.comments = ['I love this airport, didnt have to make a line for security since I had the TSA Pre-check. Terminal A is very clean and has some good restaurants.',
        'Taking a mid morning flight on Southwest, arrived about 8am to get breakfast. Nothing open in entire airport but Dunkin Donuts.',
        'Arriving on an international flight you expect to queue at immigration, but not for over 2 hours and we were almost the first off the plane.'];
